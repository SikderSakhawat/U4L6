public class SecurePassword
{
    ...
    */
    ...
    {
      if(containsDigit() && isLongEnough() && containsLowercase() && containsSpecialSymbol() && containsUppercase())
          return true;
      return false;
    }
    ...
    */
    public String status()
    {
      String statusReport = "";
      if(isSecure()){
          statusReport+= "Password is secure\n";
          return statusReport;
      }
      if(containsUppercase())
          statusReport+= "";
      else
          statusReport+= "The password must contain at least one uppercase letter.\n";
      if (containsLowercase())
          statusReport+="";
      else
          statusReport+="The password must contain at least one lowercase letter.\n";
      if(containsSpecialSymbol())
          statusReport+="";
      else
          statusReport+="The password must contain at least one special symbol: ! @ # $ % ^ & * ?\n";
      if(containsDigit())
          statusReport+="";
      else
          statusReport+="The password must contain at least one digit.\n";
      if(isLongEnough())
          statusReport+="";
      else
          statusReport+="The password must be at least 8 characters\n";
    ...
    private boolean checkString(String characterString) {
        for (int i = 0; i <= characterString.length(); i++) {
            String index = "" + characterString.charAt(i);
            if (password.indexOf(index) != 0) {
                return true;
            }
        }
        return false;
